...
$misAmigos = ["Yezer", "Karla", "Niki"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Heather", "Godzilla"); // Reemplaza las comillas vacías con los nombres de tus amigos
...
array_push($playlist, ["Billie Jean", "Michael Jackson"], ["Like a Rolling Stone", "Bob Dylan"], ["No Future", "EDEN"]);
