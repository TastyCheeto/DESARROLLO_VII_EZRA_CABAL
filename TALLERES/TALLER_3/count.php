...
$misCanciones = ["555","12:PM","the Devil in I","Give Me Head","Los Menores Terroristas"]; // Reemplaza esto con tu array de canciones
...
$playlist = [
    "Rock" => ["Master o Puppets", "Hotel California","Thunderstuck"],
    "Pop" => ["The Balad of Monaliza", "Billie Jean", "Rolling in the Deep","Feel Alive"],
    "Jazz" => ["Rivers in the Dessert", "The aperture","Con mis Perros en la Niebla"]
];
