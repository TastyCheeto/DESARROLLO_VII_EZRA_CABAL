...
$misComidas = ["Lasagna", "Patacones con keshu", "Otoe"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Zapallo", "PAsta alfredo", "Yogurt sin sabor"]; // Reemplaza con las comidas favoritas de tu amigo
